...
define config.version = "1.0(dev release 1)"
...
define gui.about = _p("""
minqwq's life，正如这个名字所说，这是我在另一个世界(幻想乡)的生活

发起者(提出想法的):Mashiro_Kanon(网名，不是那个白菜)

目前所有者:minqwq / Flandre Studio, MeltIde
""")
...
define config.main_menu_music = "init.mp3"
...
define config.save_directory = "minqwqlife-1731354432"
